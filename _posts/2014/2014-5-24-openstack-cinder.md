...
if __name__ == '__main__':
    ...
    if CONF.enabled_backends:
        ...
        ######################################
        #
        # 调用了cinder/service.Service.create()
        #
        ######################################
...
可以看到实际上cinder-volume是调用了cinder/service来实现volume功能的

但是这里关于rpc的调度似乎与原来的H版有较大变化,还需进一步研究.
...
######################################
# VolumeManager继承的基类来自/cinder/manager.py
#
######################################
class VolumeManager(manager.SchedulerDependentManager):
    ...
    def __init__(self, volume_driver=None, service_name=None,
        ...
        ######################################
        # 实际上在openstack中缺省的volume_driver为cinder.volume.drivers.lvm.LVMISCSIDriver
        #
        ######################################
        ...
        ######################################
        # 加载volume驱动模块cinder.volume.drivers.lvm.LVMISCSIDriver
        #
        ######################################
